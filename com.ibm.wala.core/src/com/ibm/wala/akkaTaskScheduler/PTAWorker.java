...
public class PTAWorker extends UntypedActor{
...
//  private HashSet<PointsToSetVariable> processed = new HashSet<>();// for pf
  ...
  private ResultFromSpecial processSpecialWorkAddition(WorkContentForSpecial work) {
...
//      further check
  ...
  private ResultFromSpecial processSpecialWorkDeletion(WorkContentForSpecial work) {
    final PointsToSetVariable user = work.getUser();
    final MutableIntSet targets = work.getTargets();
    final PropagationSystem system = work.getPropagationSystem();
