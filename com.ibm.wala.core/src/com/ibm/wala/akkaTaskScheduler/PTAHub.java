...
public class PTAHub extends UntypedActor{
  ...
  public PTAHub(final int nrOfWorkers) {
    this.nrOfWorkers = nrOfWorkers;
    Props props = Props.create(PTAWorker.class).withRouter(new BalancingPool(nrOfWorkers));
...
//      System.err.println("num of works: " + nrOfWorks);
  ...
  private void analyzeResultFromS(ResultFromSpecial result) {
