...
/**
 * Test for deadlocks in the code, and test the deadlockexception detection mechanism.
 */
public class NewTestDeadlock extends TestBase {
    ...
    private void testConcurrentLobReadAndTempResultTableDelete() throws Exception {
        deleteDb("deadlockexception");
        String url = "deadlockexception;MAX_MEMORY_ROWS=10";
        Connection conn, conn2;
        Statement stat2;
        conn = getConnection(url);
        conn2 = getConnection(url);
    ...
    private void initTest() throws SQLException {
        c1 = getConnection("deadlockexception");
        c2 = getConnection("deadlockexception");
        c3 = getConnection("deadlockexception");
